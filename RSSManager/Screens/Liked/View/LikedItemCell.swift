...
class LikedItemCell: UITableViewCell, BaseView {
    
    private lazy var titleLabel: UILabel = UILabel()
    private lazy var descriptionLabel: UILabel = UILabel()
    private lazy var itemImageView: UIImageView = UIImageView()
    lazy var containerView: UIView = UIView()
    lazy var deleteImageView: UIImageView = UIImageView(image: UIImage(systemName: "trash.fill")!.withRenderingMode(.alwaysOriginal).withTintColor(.red.withAlphaComponent(0.7)))
    
    static let cellIdentifier = "LikedItemCell"
    ...
    func positionSubviews() {
        ...
        deleteImageView.anchor(top: containerView.topAnchor, trailing: containerView.trailingAnchor, padding: UIEdgeInsets(top: 4, left: 0, bottom: 0, right: 4), size: CGSize(width: 20, height: 20))
        ...
        titleLabel.anchor(top: containerView.topAnchor, leading: containerView.leadingAnchor, trailing: deleteImageView.leadingAnchor, padding: UIEdgeInsets(top: 4, left: 4, bottom: 0, right: 4))
